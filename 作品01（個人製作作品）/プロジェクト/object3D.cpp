...
HRESULT CObject3D::Init()
{
	...
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(m_pos3D.x - m_fLength3D_x, m_pos3D.y + m_fLength3D_y, m_pos3D.z + m_fLength3D_z);
	pVtx[1].pos = D3DXVECTOR3(m_pos3D.x + m_fLength3D_x, m_pos3D.y + m_fLength3D_y, m_pos3D.z + m_fLength3D_z);
	pVtx[2].pos = D3DXVECTOR3(m_pos3D.x - m_fLength3D_x, m_pos3D.y - m_fLength3D_y, m_pos3D.z - m_fLength3D_z);
	pVtx[3].pos = D3DXVECTOR3(m_pos3D.x + m_fLength3D_x, m_pos3D.y - m_fLength3D_y, m_pos3D.z - m_fLength3D_z);
...
void CObject3D::Draw()
{
	...
	//向きを反映
	D3DXMatrixRotationYawPitchRoll(&mtxRot, m_rot3D.y, m_rot3D.x, m_rot3D.z);

	D3DXMatrixMultiply(&m_mtxWorld, &m_mtxWorld, &mtxRot);

	//位置を反映
	D3DXMatrixTranslation(&mtxTrans, m_pos3D.x, m_pos3D.y, m_pos3D.z);
...
void CObject3D::SetParam(D3DXVECTOR3 length)
{
	m_fLength3D_x = length.x;
	m_fLength3D_y = length.y;
	m_fLength3D_z = length.z;
}
